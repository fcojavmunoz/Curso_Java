...
class MarcoVentana4 extends JFrame {
    public MarcoVentana4(){
        setVisible(true);
...
/* AL implementar WindowListener (implements WindowListener) estamos obligados a construir los siete métodos que
incluye. Para poder evitarlo podemos usar las Clases Adaptadoras: extends WindowAdapter
 */

class M_Ventana4 extends WindowAdapter {
